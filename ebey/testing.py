...
def example():
    try:
        ...
        api = Connection(config_file='Entities/ebayconf.yaml', domain='svcs.sandbox.ebay.com')
...
if __name__ == '__main__':
    handler = EbayHandler()
    mock_request = SearchRequest(title='computer', query='laptop', num_results=5, preferences={})
